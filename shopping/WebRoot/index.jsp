        ...
        <tr> 
		  <%
              ...
              for(int i=0;i<free;i++)
              {
                ...
                %>
            <td valign="top"><table width="257" height="136" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#999999">
              <tr>
...
<table width="100%"  border="0"  bordercolor="#FFFFFF" align="center" cellpadding="0" cellspacing="0">
